...
public class RandomMovementOfAgentOnNavMesh : MonoBehaviour
{
    private NavMeshAgent agent;
    private GetRandomSpotOnNavMesh getRandomSpotOnMap;
    private float deeleyTesting = 1.5f;
    private Vector3 destination;
    private float stoppingDistance = 6f;

    public void SetRandomMapController(GetRandomSpotOnNavMesh obj)
    {
